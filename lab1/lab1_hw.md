...
RSTudio is a GUI that makes it easier working in R. GitHub is a website that stores and manages files. Programmers upload code onto GitHub where it becomes publicaly available.
...
It knows to follow order of operations
