...
homerange2%>%
  ...
  ggplot(aes(x=common.name,y=log10.mass))+geom_col()+coord_flip() #coord_flip automatically flips axises
```
```{r}
homerange2%>%
  top_n(-10,log10.mass)%>% #different way of getting 10 smallest
  ggplot(aes(y=common.name,x=log10.mass))+geom_col()
```
