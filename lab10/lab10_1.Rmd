...
```{r}
elephants %>% 
  ggplot(aes(x=age, y=height)) + geom_point() + geom_smooth(method=lm, se=F)+labs(title="Elephant Age vs Height",x="Age",y="Height")+theme(plot.title = element_text(size = rel(1.5),hjust=.5))
```
