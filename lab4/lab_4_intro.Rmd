...
1. How is a data frame and how is it different than a data matrix?
  data frame is a cleaner way to look at and organize data, can use multiple classes of data, looks like a spreadsheet
...
3. Take a moment to show your repository on GitHub to a partner. Can you make any improvements?  
  my hw is in my lab folder, could be more clearly organized in a sub-folder in the lab folder labelled hw
